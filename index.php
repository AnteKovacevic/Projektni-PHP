...
<html lang="en">
	...
	if (!isset($menu) || $menu == 1) {
		...
		<figure>
			...
			<img class="image2" src="images/html.jpg" alt="HTML5" title="HTML5"/>
		...
		<p>Social media:<br>
			<a href="https://www.linkedin.com/in/tim-berners-lee-b41808ab/" target="_blank"><img src="images/linkedin.png" alt="Linkedin" title="Linkedin" style="width:25.5px; margin-top:0.4em"></a>
			<a href="https://twitter.com/timberners_lee" target="_blank"><img src="images/Twitter.png" alt="Twitter" title="Twitter" style="width:24px; margin-top:0.4em"></a>
			<a href="https://plus.google.com/113372414904624897851" target="_blank"><img src="images/g+.png" alt="Google+" title="Google+" style="width:24px; margin-top:0.4em"></a>
		</p>';
	}
	else if ($menu == 2) {
		print '
